...
class App():
    ...
    def save_results_csv(self):
        with open('historial.csv', 'a') as csvfile:
            ...
            showinfo(title='Guardar', message=mensajes.save_())
    ...
    def create_pdf(self):
        ...
        img.save(pdf_path)
        self.reportID += 1
        showinfo(title='PDF', message=mensajes.pdf_successful_())

    def delete(self):
        answer = askokcancel(title='Confirmación', message=mensajes.confirmation, icon=WARNING)
        if answer:
            ...
            showinfo(title='Borrar', message=mensajes.confirmation_delete_())    
